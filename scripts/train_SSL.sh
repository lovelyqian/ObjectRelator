...
deepspeed --master_port=29502 psalm/train/train_SSL.py \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path "/data/work-gcp-europe-west4-a/yuqian_fu/Ego/huggingface/hub/phi-1_5_dev" \
    --version "llava_phi" \
    --region_json_path "/data/work-gcp-europe-west4-a/yuqian_fu/Ego/data_segswap/EgoQuery_SmallTrain_byorder.json" \
    ...
    --fp16 True \
    --output_dir /data/work-gcp-europe-west4-a/yuqian_fu/Ego/SSL_EgoQuery_SmallJson_1030_exp3_cos_k50_withnorm\
    --num_train_epochs 4 \
