...
deepspeed psalm/train/train.py \
    ...
    --version "llava_phi" \
    --region_json_path "/data/work-gcp-europe-west4-a/yuqian_fu/Ego/data_segswap/ExoQuery_FullTrain.json" \
    ...
    --fp16 True \
    --output_dir /data/work-gcp-europe-west4-a/yuqian_fu/Ego/ExoQuery_241025_psalm_retrain_withPretrained_onFULLTrainJson_ep4 \
    --num_train_epochs 4 \
