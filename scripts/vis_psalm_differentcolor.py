...
if __name__ == "__main__":
    ...
    #takes_ids = ["6bd00296-7ae3-41c9-89fd-52ba9410018f", "c9e0bbae-4092-4ab1-95cd-16b905709a0e", "6eb10b39-5171-4293-afba-4084f5825748", "b5f62731-3deb-4bac-b00c-fe96e57d86b3", "8caf94c0-835e-48cd-9e7c-fa6bfddc0d5c", "a56ce926-8c85-4883-9ff5-dd7779d71b64", "87a09132-b107-40bf-aca0-1ae6e5dc46cd", "f76f2040-989c-42df-b2fb-e0903165443d", "526b8408-7edc-4390-a1cc-44512faaa432"]
    ...
    for take_id in tqdm.tqdm(takes_ids):
        ...
        #debug:检查是否存在
        # test_path = f"{output_path}/{setting}/cooking/{take_id}"  #debug
        ...
        out_path = f"{output_path}/{setting}/music/{take_id}/predictions_{model_name}/{target_cam}"  #debug
        os.makedirs(
