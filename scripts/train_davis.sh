...
deepspeed --master_port=29532 psalm/train/train_SSL_MultiCondition.py \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path "/data/work-gcp-europe-west4-a/yuqian_fu/Ego/huggingface/hub/phi-1_5_dev" \
    --version "llava_phi" \
    --region_json_path "/data/work-gcp-europe-west4-a/yuqian_fu/datasets/DAVIS/2017/trainval_val_psalm_train_new_augument_n4_instruction_1118.json" \
    ...
    --image_folder "/data/work-gcp-europe-west4-a/yuqian_fu/datasets/DAVIS" \
    ...
    --fp16 True \
    --output_dir /data/work-gcp-europe-west4-a/yuqian_fu/Ego/DAVIS-PSALMModel-from-PSALMPretrained-Epoch4-SSL-augument-n4-1119 \
    --num_train_epochs 5 \
