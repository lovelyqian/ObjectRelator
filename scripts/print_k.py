...
def train():
    ...
    model2 = PSALM_SSL_MultiCondition.from_pretrained(
        # model_args.model_name_or_path,
        #"/data/work2-gcp-europe-west4-a/yuqian_fu/Ego/huggingface/hub/PSALM",
        "/data/work-gcp-europe-west4-a/yuqian_fu/Ego/OursMultiCondition_EgoQuery_SmallJson_1101_CAwithlearnableweight_1Head_TwoStageS2/checkpoint-3056", #egosmall_ours_multicondition_TwostageS1
        mask_decoder_cfg=mask_cfg,
        add_cross_attn=True,
        cache_dir=training_args.cache_dir,
        **bnb_model_from_pretrained_args
    ...
    for name, param in model2.named_parameters():  #xiugai
        if "fuse_model" in name:
