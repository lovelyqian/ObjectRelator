#!/bin/bash
#SBATCH --job-name=eva_framelevel2
...
#SBATCH --output=Ablation_SSL_k0dot5_ecu_1121_v1.log     # Redirect stdout to a log file
...
python psalm/eval/eval_ego4d.py --image_folder /data/work2-gcp-europe-west4-a/yuqian_fu/Ego/data_segswap --model_path /data/work-gcp-europe-west4-a/yuqian_fu/Ego/Ablation_SSL_k0dot5_ecu_1121/checkpoint-2000 --json_path /data/work-gcp-europe-west4-a/yuqian_fu/Ego/data_segswap/egoexo_val_framelevel_all.json
