...
class COCO_interactive_dataset(COCO_panoptic_dataset):
    def __init__(self, json_path, tokenizer, data_args):
        ...
        #self.data = self.data[:NUM] #v1
        self.data = self.data[NUM:2*NUM] #v2
        #self.data = self.data[2*NUM:3*NUM] #v3
        #self.data = self.data[3*NUM:4*NUM] #v4
        #self.data = self.data[7*NUM:] #v8
        #self.data = self.data[:10]
        #self.data = self.data[7*NUM:] #v7
        # self.data = self.data[5*NUM: 5*NUM+1735] #v6.1
        # self.data = self.data[5*NUM+1735: 5*NUM+1735*2] #v6.2
        # self.data = self.data[5*NUM+1735*2: ] #v6.2
        ...
        #self.data = self.data[16000:24000]
        # self.data = self.data[-500:] #debug
    ...
    def __init__(self, json_path, tokenizer, data_args):
        if isinstance(json_path, list):
            ...
            with open(json_path) as f:
                data = json.load(f)
        self.data = data
        # self.data = self.data[:1000] #debug
        self.tokenizer = tokenizer
        self.data_args = data_args
        self.mask_format = 'polygon'
        coco_class_ids = [
