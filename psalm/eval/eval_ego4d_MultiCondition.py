...
if __name__ == '__main__':
    ...
    # from tqdm import tqdm
    # ego_query = True
    # data_list = json.load(open('/data/emzhang/data/egoexo4d_correspondence_val/annotation_split.json'))
    ...
    #         cur_data = {}
    #         cur_data['take_uid'] = data['take_uid']
    #         cur_data['take_frame'] = data['take_frame']
    #         cur_data['root_dir'] = data['root_dir']
    #         cur_data['object_list'] = [obj]
    #         cur_data[obj] = data[obj]
    #         split_data_list.append(cur_data)
    # print(f'total split data is {len(split_data_list)}')
    # with open('/data/emzhang/data/egoexo4d_correspondence_val/annotation_split.json','w') as f:
    #     json.dump(split_data_list,f)

    # filtered_data = []
    # for data in tqdm(data_list):
    #     image_root = os.path.join('/data/emzhang/data/egoexo4d_correspondence_val', data['root_dir'], 'frame_aligned_videos/downscaled/448')
    #     image_frame = str(data['take_frame']) + '.jpg'
    #     image_path = None
    #     vp_image_path = None
    #     vp_mask_list = []
    ...
    # print(f'filtered data len {len(data_list)} vs {len(filtered_data)}')
    # with open('/data/emzhang/data/egoexo4d_correspondence_val/annotation_filtered.json', 'w') as f:
