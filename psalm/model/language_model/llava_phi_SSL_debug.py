...
class PSALM_SSL(PhiForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        if (input_ids == SEG_TOKEN_INDEX).sum() != 0:
            ...
            #input_ids_exo, attention_mask_exo, past_key_values_exo, inputs_embeds_exo, labels_exo, seg_query_mask_exo, class_name_embedding_indices_exo, region_embedding_masks_exo, refer_embedding_indices_exo = self.prepare_inputs_labels_for_multimodal(input_ids, attention_mask, past_key_values, labels, images, vp_images, class_name_embedding_indices,class_name_ids, cls_indices, instances, token_refer_id, refer_embedding_indices)
            # print('After the prepare_inputs_labels_for_multimodal_SSL:', inputs_embeds.shape, inputs_embeds_exo.shape)
        ...
        # print('use_cache:', use_cache, 'output_hidden_states:', output_hidden_states, 'return_dict:', return_dict)
        ...
        #region_embedding_list_2  = [v.detach().clone() for v in region_embedding_list]
        #loss_region_emb_SSL = calculate_region_embedding_dis(region_embedding_list_2, region_embedding_list_exo)
        
        #loss_region_emb_SSL = calculate_region_embedding_dis(region_embedding_list, region_embedding_list_exo)
        loss_region_emb_SSL = calculate_region_embedding_dis(region_embedding_list, region_embedding_list_exo, sim_type="cos", L2_norm=True)
        ...
        if seg_query_mask is not None:
            ...
            if seg_info is not None:
                ...
                #debug: 调整loss_region_emb_SSL的系数
                k_SSL = 50
